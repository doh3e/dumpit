...
export default function PrivacyPolicyModal({ onClose }) {
  return createPortal(
    <div className="fixed inset-0 z-[80] flex items-center justify-center">
      ...
      <div className="relative card-retro w-full max-w-2xl mx-4 max-h-[90vh] flex flex-col">
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-dungeon text-dark text-xl">개인정보처리방침</h2>
          <button
            onClick={onClose}
        ...
        <div className="mb-3 text-xs text-sub font-semibold space-y-1">
