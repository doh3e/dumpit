...
const SECTIONS = [
    ...
    body: (
      <>
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>서비스 내 활동 기록 (태스크 생성·수정·삭제 등 주요 액션)</li>
  ...
  },
  {
    ...
    body: (
      <>
        <p className="mb-2">
          이용자의 개인정보는 회원 탈퇴 시 지체 없이 파기됩니다. 단, 관계 법령에 따라 보존이 필요한 경우 해당 법령에서 정한 기간 동안 보관하며, 서비스 운영상 필요한 로그는 아래 기간 동안 보관 후 파기합니다.
        </p>
        <ul className="list-disc pl-5 space-y-1">
      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="card-kitschy space-y-6">
          <div>
            ...
            <p className="text-xs text-dark/60 font-semibold mt-2">시행일자: 2026년 4월 25일</p>
          </div>
