...
const SECTIONS = [
    ...
    body: (
      <>
        ...
        <ol className="list-decimal pl-5 space-y-1">
          <li>“서비스”란 태스크 관리, 브레인덤프, 아이디어 정리, 루틴 관리 등을 제공하는 생산성 서비스인 덤핏(Dumpit!)을 말하며, 웹사이트(https://dumpit.kr)와 모바일 애플리케이션 및 데스크탑 애플리케이션을 포함합니다.</li>
  ...
  },
  {
    ...
    body: (
      <ol className="list-decimal pl-5 space-y-1">
        <li>이용자는 서비스 내 마이페이지 또는 모바일 애플리케이션의 설정을 통하여 언제든지 이용계약을 해지(회원 탈퇴)할 수 있습니다.</li>
        <li>탈퇴 즉시 서비스 이용이 중단되며, 이용자가 등록한 태스크, 아이디어, 루틴, 브레인덤프 등 서비스 이용 데이터는 조회할 수 없게 됩니다.</li>
        <li>운영자는 이용자의 착오에 의한 탈퇴를 구제하기 위하여 탈퇴일부터 30일 동안 계정과 서비스 이용 데이터를 복구 목적으로 보관합니다. 이 기간에 동일한 Google 계정으로 다시 로그인하면 탈퇴가 철회되고 데이터가 복구됩니다.</li>
        <li>제3항의 기간이 지나면 계정 정보와 서비스 이용 데이터는 복구할 수 없도록 완전히 삭제됩니다.</li>
        <li>다만, 관계 법령의 준수 또는 서비스 운영상 일정 기간 보존이 필요한 기록은 개인정보처리방침에서 정하는 기간 동안 보관된 후 파기됩니다.</li>
      </ol>
    ),
  },
  {
    ...
    body: (
      <ol className="list-decimal pl-5 space-y-1">
        ...
        <li>운영자는 이용자가 입력한 콘텐츠를 인공지능 모델의 학습에 사용하지 않습니다.</li>
        <li>운영자는 서비스 개선을 위하여 개인을 식별할 수 없는 형태의 이용 통계를 분석할 수 있으며, 이 경우에도 이용자의 콘텐츠 원문은 이용하지 않습니다.</li>
      </ol>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <div className="space-y-1">
        <p>이 약관은 2026년 8월 18일부터 시행됩니다.</p>
        <p>종전의 약관은 2026년 7월 15일부터 2026년 8월 17일까지 적용됩니다.</p>
      </div>
    ),
  },
]
