...
class TaskServiceImplTest {
    ...
    void setUp() {
        ...
        when(openAiService.scorePriority(any(), any(), any(), any(), any()))
    ...
    void 마감만_입력하면_시작시간을_역산하지_않는다() {
        when(openAiService.inferSchedule(any(), any(), any(), any(), any(), any(), any()))
    ...
    void 시작과_마감이_모두_있으면_예상시간을_간격으로_파생하지_않는다() {
        ...
        verify(openAiService, never()).inferSchedule(any(), any(), any(), any(), any(), any(), any());
    }
