...
public class ShopCatalog {
    ...
    private static final List<ShopItem> ITEMS = List.of(
        ...
        // 가격 정책(2026-07-22 확정): 발사형(스프라이트만 교체) 600 통일,
        // 전용 모션 1000, 스펙터클(유성우·불꽃놀이) 1200
        ShopItem.theme("celeb.shooting-star", CELEBRATION, "별똥별",   "완료 축하로 별똥별이 지나가요.",  600, CONCEPT),
        ShopItem.theme("celeb.ufo",           CELEBRATION, "UFO",     "완료 축하로 UFO가 날아올라요.",   600, CONCEPT),
        ShopItem.theme("celeb.golden-rocket", CELEBRATION, "황금 로켓", "반짝이는 황금 로켓 발사!",       600, CONCEPT),
        ShopItem.theme("celeb.fireworks",     CELEBRATION, "불꽃놀이",    "밤하늘 가득 팡팡! 최고의 피날레예요.",      1200, CONCEPT),
        ...
        ShopItem.theme("station.sprout",  STATION, "새싹 온실",     "새싹이 자라는 유리 온실이에요.",        600, CONCEPT),
        ShopItem.theme("station.galaxy",  STATION, "은하수 전망대", "별을 올려다보는 돔 전망대예요.",        600, CONCEPT),
        ShopItem.theme("station.wood",    STATION, "원목 오두막",   "굴뚝 연기가 피어나는 통나무 오두막이에요.", 600, CONCEPT),
        ShopItem.theme("station.candy",   STATION, "과자집",       "사탕으로 장식한 달콤한 과자집이에요.",    600, CONCEPT),
        ShopItem.theme("station.dog",     STATION, "강아지",       "꼬리를 흔들며 반겨주는 강아지예요.",      800, CONCEPT),
        ShopItem.theme("station.cat",     STATION, "고양이",       "꼬리를 살랑이는 새침한 고양이예요.",      800, CONCEPT),
        ShopItem.theme("station.hamster", STATION, "햄스터",       "쳇바퀴를 신나게 돌리는 햄스터예요.",     1000, CONCEPT),
